...
export default function Projects() {
  ...
  const dataList = [
    ...
    { image: trebuchet1, number:'(3)',name: 'handwriting-prediction', caption: 'The Terrible Trebuchet', subcaption: 'Python, Pytorch, Torchvision', summary: 'A GUI program that allows users to download datasets, view dataset images, upload models to train, and predict handwritten letters/digits'},
    { image: line1, number:'(4)', name: 'handwriting-prediction', caption: 'Line Following Robot', subcaption: 'Python, Pytorch, Torchvision', summary: 'A GUI program that allows users to download datasets, view dataset images, upload models to train, and predict handwritten letters/digits'},
    ...
    { image: circle1, number:'(6)', name: 'handwriting-prediction', caption: 'Circle Me, Circle You', subcaption: 'Python, Pytorch, Torchvision', summary: 'A GUI program that allows users to download datasets, view dataset images, upload models to train, and predict handwritten letters/digits'},
    { image: box3, number:'(7)', name: 'handwriting-prediction', caption: 'Flappy Box ', subcaption: 'Python, Pytorch, Torchvision', summary: 'A GUI program that allows users to download datasets, view dataset images, upload models to train, and predict handwritten letters/digits'},
